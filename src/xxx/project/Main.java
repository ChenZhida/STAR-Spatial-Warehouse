...
//        SysOutOverSLF4J.sendSystemOutAndErrToSLF4J();
        ...
        int parallelismRouter = 1;
        int parallelismWorker = 1;
        int parallelismMerger = 1;
        int parallelismQueryAnalyzer = 1;
        int parallelismContinuousWorker = 1;
        Properties props = new Properties();
//        props.put(Constants.ROUTER_TYPE_CONFIG, Constants.LOAD_BASED_QUADTREE_ROUTER);
        props.put(Constants.ROUTER_TYPE_CONFIG, Constants.RANDOM_ROUTER);
        props.put(Constants.WORKER_INDEX_TYPE_CONFIG, Constants.NAIVE_WORKER);
